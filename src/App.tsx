  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center text-black'>
        ...
        <button className='mt-4 text-white transition-transform transform hover:scale-110 hover:text-blue-200' onClick={() => navigate("/temperature")}>Start view data</button>
      </div>
